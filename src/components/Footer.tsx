      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="text-sm text-center md:text-left">
            <p className="font-semibold text-gray-900">Mapa Electoral Colombia 2026</p>
            <p className="text-gray-500 mt-1">
              Análisis de resultados electorales presidenciales
            </p>
          </div>
          ...
          <div className="flex items-center gap-6">
            ...
            <a
              href="https://www.facebook.com/CHRISTHNN?locale=es_LA"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://www.linkedin.com/in/cristhian-lunaa/"
              target="_blank"
              rel="noopener noreferrer"
